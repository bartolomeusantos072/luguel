...
Back-end for luguel, an event management solution.

## About

luguel is a web browser application with which you can manage every single aspect of your event.
...
Set `POSTGRES_HOST` to `luguel-postgres-development` for `.env.development` and `luguel-postgres-test` for `.env.test` file. It is the name of the postgres container inside docker-compose file. Docker Compose will start the postgres container for you, create the database and host alias for you.
